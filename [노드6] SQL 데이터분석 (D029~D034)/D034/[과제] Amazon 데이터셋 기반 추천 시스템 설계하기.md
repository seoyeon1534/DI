...
## 추천 시스템 1 _ "카테고리 안에서 할인 혜택이 큰 상품이에요"
---
...
**4. 결과**
![alt text](image.png)
➜ 'Computers&Accessories' 카테고리 안에서 할인율 89%에서 94%에 달하는 케이블/충전기류 상품들이 상위에 노출되었고, 평점도 3.9~4.3으로 낮지 않아 실제로 "혜택도 크고 품질도 검증된" 상품이 잘 걸러지는 것을 확인

---

## 추천 시스템 2 _ "리뷰에서 '내구성 좋다'고 언급된 상품이에요"
...
## 추천 시스템 5 _ "카테고리 안에서 평점이 유독 좋은 상품이에요"
